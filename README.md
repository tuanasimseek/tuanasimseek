...
Yazılım Mühendisliği son sınıf öğrencisiyim — Haziran 2026 mezuniyeti.  
Backend geliştirme (.NET & Django), mobil (Flutter) üzerine çalışıyorum.  
Şu an aktif olarak **Django** ile backend projeleri geliştiriyorum.

---

## Kullandığım Teknolojiler

**Backend:** Python · Django · REST Framework · C# · .NET · JWT · Identity  
**Mobile:** Flutter · Dart · Dio  
**ML/IoT:** scikit-learn · XGBoost · PyTorch · C++ · Arduino · TFLite  
**Oyun:** Unity · C#  
**Araçlar:** Git · GitHub · Jupyter Notebook · SQL · Postman
